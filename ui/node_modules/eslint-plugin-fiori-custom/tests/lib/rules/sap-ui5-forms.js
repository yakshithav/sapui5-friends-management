...
// Requirements
//------------------------------------------------------------------------------
var rule = require("../../../lib/rules/sap-ui5-forms.js"),
...
ruleTester
    .run("sap-ui5-forms", rule, {
        valid: [
            ...
            {
                code:
                ` oParameters.show("", oParameters.mainNavigation, aActions, new sap.ui.layout.form.SimpleForm({
                    maxContainerCols: 2,
                    columnsL: 1,
                    columnsM: 1,
                    content: [
        ...
        invalid: [
            ...
            {
                code:
                    `var oSF3 = new sap.ui.layout.form.SimpleForm("SF3", {
            ...
            {
                code:
                    `var oSF4 = new sap.ui.layout.form.SimpleForm("SF4", {
            ...
            {
                code:
                    `var oSF5 = new sap.ui.layout.form.SimpleForm("SF5", {
            ...
            {
                code:
                    `var oF3 = new sap.ui.layout.form.Form("F3", {
                                    title: "Unsupported VBox",
                                    editable: true,
                                    layout: new sap.ui.layout.form.ResponsiveGridLayout(),
                                    formContainers: [
            ...
            {
                code:
                    `var oF4 = new sap.ui.layout.form.Form("F4", {
                                    title: "Unsupported HBox",
                                    editable: true,
                                    layout: new sap.ui.layout.form.ResponsiveGridLayout(),
                                    formContainers: [
            ...
            {
                code:
                    `var oF5 = new sap.ui.layout.form.Form("F5", {
                                    title: "Unsupported Table",
                                    editable: true,
                                    layout: new sap.ui.layout.form.ResponsiveGridLayout(),
                                    formContainers: [
            ...
            {
                code:
                    `var oSF3 = new sap.ui.comp.smartform.SmartForm("SF3", {
                                    title: "Unsupported VBox",
                                    editable: true,
                                    layout: new sap.ui.comp.smartform.Layout(),
                                    groups: [
            ...
            {
                code:
                    `var oSF4 = new sap.ui.comp.smartform.SmartForm("SF4", {
                                    title: "Unsupported HBox",
                                    editable: true,
                                    layout: new sap.ui.comp.smartform.Layout(),
                                    groups: [
            ...
            {
                code:
                    `var oSF5 = new sap.ui.comp.smartform.SmartForm("SF5", {
                                    title: "Unsupported Table",
                                    editable: true,
                                    layout: new sap.ui.comp.smartform.Layout(),
                                    groups: [
