...
var rule = require("../../../lib/rules/sap-browser-api-error.js"),
...
var errorMessage1 = "location.reload() is not permitted.";
var errorMessage2 = "Global event handling override is not permitted, please modify only single events";
var errorMessage3 = "Proprietary Browser API access, use sap.ui.Device API instead";
var errorMessage4 = "Dynamic style insertion, use library CSS or lessifier instead";
ruleTester
        .run("sap-browser-api-error", rule, {
                    valid: [
                    ...
                    invalid: [
                            ...
                            },
                            {
                                ...
                                errors: [
                                    {
                                        message: "insertBrOnReturn is not allowed since it is a Mozilla specific method, Chrome doesn't support that.",
                                        type: "MemberExpression"
                                    }
                                ]
                            },
