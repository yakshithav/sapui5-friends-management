...
var rule = require("../../../lib/rules/sap-ui5-legacy-factories.js"),
...
ruleTester
        .run("sap-ui5-legacy-factories", rule, {
                    valid: [
                        {
                            code: 
                    ...
                    invalid: [
                        {
                            ...
                            errors: [
                                {
                                    message: "Make use of sap.ui.define([...], function(...) {...} to load required dependencies. Legacy UI5 factories leading to synchronous loading.",
                                    type: "CallExpression"
                                }
                            ]
                        },
