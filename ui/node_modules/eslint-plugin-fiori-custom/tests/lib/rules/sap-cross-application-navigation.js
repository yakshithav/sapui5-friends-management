...
// ------------------------------------------------------------------------------
// Invoking strict mode syntax for whole script
// ------------------------------------------------------------------------------
"use strict";
...
var rule = require("../../../lib/rules/sap-cross-application-navigation.js"),
...
var errorMessage = "Do not use a static list of cross-application navigation targets.";
ruleTester.run("sap-cross-application-navigation", rule, 
                {
                    ...
                    invalid: [
                            ...
                            {
                                code: "var oCrossAppNavigator = fgetService('CrossApplicationNavigation');"
                            ...
                            {
                                code: "var oCrossAppNavigator = fgetService && fgetService('CrossApplicationNavigation');"
                                        + "oCrossAppNavigator.toExternal({});",
                                errors: [
                                    {
                                        message: errorMessage,
