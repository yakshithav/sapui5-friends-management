...
var rule = require("../../../lib/rules/sap-message-toast.js"),
...
var errorMessage = "Value for duration of sap.m.MessageToast.show should be greater or equal to 3000!";
ruleTester.run("sap-message-toast", rule,              
                {
                    ...
                    valid: [
                            ...
                            "sap.m.MessageToast.show('Toast is ready!', {"
                                    + "'duration': 3000, " + "width: '15em', "
                                    + "onClose: null," + "autoClose: true,"
                                    + "my: 'center bottom', "
                                    + "at: 'center bottom', "
                                    + "collision: 'fit fit'" + "});",
                            ...
                            "var myOwnDuration = 200; sap.m.MessageToast.show('Toast is ready!', {"
                                    + "duration: myOwnDuration" + "});",
                            "sap.m.MessageToast.show('Toast is ready!', {"
                                    + "width: '1500px', " + "});",
