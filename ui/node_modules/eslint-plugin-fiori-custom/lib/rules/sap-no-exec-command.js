...
module.exports = {
    create: function(context) {
        "use strict";
        var MSG = "Direct DOM Manipulation, better to use jQuery.appendTo if really needed";
        var WINDOW_OBJECTS = [];
            ...
            "MemberExpression": function(node) {
                if (isDocumentObject(node.object)
                    && (isIdentifier(node.property)
                        && node.property.name === "execCommand" || isLiteral(node.property)
                        && node.property.value === "execCommand")) {
