...
export default async function generateChangesXml(messages, changeSets, content, resource) {
...
function toPosition(position, lines) {
    let pos;
    if (position.line === 0) {
...
//# sourceMappingURL=generateChangesXml.js.map