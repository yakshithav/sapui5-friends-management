...
export default class TypeLinter {
    ...
    async lint() {
        ...
        for (const sourceFile of program.getSourceFiles()) {
            ...
            const linter = new SourceFileLinter(this, sourceFile, checker, reportCoverage, messageDetails, apiExtract, this.#filePathsWorkspace, this.#workspace, ambientModuleCache, fixFactory, manifestContent, this.#libraryDependencies);
            await linter.lint();
            linterDone();
        }
        ...
        if (virtualXMLResources.length > 0) {
            ...
            for (const sourceFile of program.getSourceFiles()) {
                ...
                const linterDone = taskStart("Type-check resource", sourceFile.fileName, true);
                const linter = new SourceFileLinter(this, sourceFile, checker, reportCoverage, messageDetails, apiExtract, this.#filePathsWorkspace, this.#workspace, ambientModuleCache);
                await linter.lint();
                linterDone();
            }
        }
